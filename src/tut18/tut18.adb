...
procedure Tut18 is
  ...
  -- NOTE: I diverge here from lazyfoo as I'm not testing for support of
  --        particular GL version. Anything that doesn't support 3.3 is not
  --        even worth considering. Hopefully MESA will support it soon enough.
  -- NOTE: Even more divergence here. Not using struct as that may or may not
  --      work depending on one's choice of programming language.
