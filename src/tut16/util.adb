...
package body Util is
  ...
  ---------------------------------------------------------------------------
  -- Vertices
  Quad_Vertices: array (1 .. 8) of Float;
  ...
  is
  begin
    Quad_Vertices (1) := Float (Screen_Width) * 1.0 / 4.0;
    Quad_Vertices (2) := Float (Screen_Height) * 1.0 / 4.0;

    Quad_Vertices (3) := Float (Screen_Width) * 3.0 / 4.0;
    Quad_Vertices (4) := Float (Screen_Height) * 1.0 / 4.0;

    Quad_Vertices (5) := Float (Screen_Width) * 3.0 / 4.0;
    Quad_Vertices (6) := Float (Screen_Height) * 3.0 / 4.0;

    Quad_Vertices (7) := Float (Screen_Width) * 1.0 / 4.0;
    Quad_Vertices (8) := Float (Screen_Height) * 3.0 / 4.0;
  ...
  begin
    ...
    begin
      -- Set vertex data
      GL.Vertex_Pointer (2, GL.GL_FLOAT, 0, Quad_Vertices'Address);
      -- Draw quad using vertex data
      GL.Draw_Arrays (GL.GL_QUADS, 0, 4);
    end;
