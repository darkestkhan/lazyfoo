...
package body Util is
  ...
  -- Sprite area
  Arrow_Clips: Rect.Rect_F_Array (1 .. 4);
  ...
  begin
    ...
    begin
      if Error /= IL.IL_NO_ERROR then
        TIO.Put_Line (TIO.Standard_Error, "Error initializing DevIL!");
      end if;
    end;
  ...
  begin
    -- Set clip rectangles
    Arrow_Clips (1).X := 0.0;
    Arrow_Clips (1).Y := 128.0;
    Arrow_Clips (1).W := 128.0;
    Arrow_Clips (1).H := 128.0;

    Arrow_Clips (2).X := 128.0;
    Arrow_Clips (2).Y := 128.0;
    Arrow_Clips (2).W := 128.0;
    Arrow_Clips (2).H := 128.0;

    Arrow_Clips (3).X := 0.0;
    Arrow_Clips (3).Y := 0.0;
    Arrow_Clips (3).W := 128.0;
    Arrow_Clips (3).H := 128.0;

    Arrow_Clips (4).X := 128.0;
    Arrow_Clips (4).Y := 0.0;
    Arrow_Clips (4).W := 128.0;
    Arrow_Clips (4).H := 128.0;

    -- Load texture
    Texture.Load_Texture_From_File (Loaded_Texture, "data/07.png", Success);
  ...
  begin
    ...
    Texture.Render
      ( Loaded_Texture,
        Float (Screen_Width) - Arrow_Clips (2).W,
        0.0,
        True,
        Arrow_Clips (2)
      );
    Texture.Render
      ( Loaded_Texture,
        0.0,
        Float (Screen_Height) - Arrow_Clips (3).H,
        True,
        Arrow_Clips (3)
      );
    Texture.Render
      ( Loaded_Texture,
        Float (Screen_Width) - Arrow_Clips (4).W,
        Float (Screen_Height) - Arrow_Clips (4).H,
        True,
        Arrow_Clips (4)
      );
